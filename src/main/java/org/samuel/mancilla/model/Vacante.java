...
public class Vacante {
	...
	private LocalDate fecha=LocalDate.now(); //fecha de publicación
	private Double salario; //Salario aproximado de trabajo
	//Variable adicional
	private Integer destacado; //1 - Destacada, 0 - NO destacada
	private String imagen="Daredevil.jpg";
	private String estatus;
	private String detalles;
	
	/*Se asocia la variable categoria con la clase Categoria*/
	//@Transient
	@OneToOne
	...
	//Se convierten a null los campos de imagen y fecha para poder hacer consultas
	public void reset() {
		this.imagen=null;
		this.fecha=null;
	}
